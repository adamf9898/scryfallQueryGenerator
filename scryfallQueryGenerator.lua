--[[
9898-MTG-Scryfall-Query-Generator
Start at line number 6 with your queries seperated by semicolons inserted between {}.
]]
local Randomizer={[[
1d{}
]]}
...
self.createButton({label='[b]9898-MTG-Scryfall-Query-Generator[/b]',font_color={1,1,1},position={0,0.01,0},font_size=250,scale={0.4,1,0.4},rotation={0,-90,0},width=0,height=0,click_function='Z',function_owner=self})end
